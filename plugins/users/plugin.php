<?php
    ...
    class users extends Plugin {
        ...
        function getSideBox() {
            $smallicons = true;
            if ($this->site->user->id == 0) {
                return $this->render('side_login', array('register' => $GLOBALS['config']['site']['registration'], 'smallicons' => $smallicons));
            } else {
                return $this->render('side_logged_in', array('user' => $this->site->user->row, 'smallicons' => $smallicons));
            }
        }
